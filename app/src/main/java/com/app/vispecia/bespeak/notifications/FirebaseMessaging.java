...
import com.app.vispecia.bespeak.ChatActivity;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNotification(RemoteMessage remoteMessage) {
        ...
        android.app.Notification.Builder builder = notification1.getNotifications(title,body,pendingIntent,soundUri,icon);
    ...
    private void updateToken(String s) {
        ...
        db.child(user.getUid()).setValue(token);
